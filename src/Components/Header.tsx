...
export default function Header() {
  return (
    <header className="w-full flex justify-around items-center px-2 md:px-8 py-2 md:py-4 bg-gray-200 dark:bg-transparent">
      ...
      <button
        ...
        className="text-sm font-thin md:text-base w-fit flex items-center wallet-btn text-gray-900 px-4 py-3 md:px-8 md:py-5 border rounded-xl hover:brightness-90"
      >
